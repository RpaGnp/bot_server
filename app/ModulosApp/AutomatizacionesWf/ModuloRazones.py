...
class SelectorNotasAuto():
	...
	def __init__(self, driver):		
		self.driver = driver		
		self.DicRazones = {'AMPLIACION DE TAP HFC':'H','AMPLIACION DE TAP FTTH':'H','CLIENTE AUN NO DESEA EL TRABAJO':'7',
					 'CLIENTE NO TIENE DINERO':'O','CLIENTE SOLICITA REPROGRAMAR':'K',
		'DIRECCION Y/O DATOS ERRADOS':'B','DUCTOS/INFRESTRUCTURA PREDIO NO APTA':'W','EQUIPOS CLIENTE NO APTOS/NO DISPONIBLES':'6',
		'FALTA DE MATERIALES/EQUIPOS':'F','FUERA DE COBERTURA DTH':'/','FUERA DE ZONA':'Z','INSTALACIÓN REQUIERE ANDAMIO ARNES':'Y',
		'LLUVIA - FACTORES CLIMÁTICOS':'L','MAL AGENDADO/MAL PROGRAMADO':'M','NO INGRESO/CLIENTE CONFIRMA SERVICIO OK':'S',
		'NO INGRESO/CLIENTE CONFIRMA':'S','PERMISOS DE ADMINISTRACION':'P','PROBLEMA ORDEN PUBLICO/ZONA ROJA':'X',
		'PROBLEMAS EN LA RED EXTERNA':'%','PROBLEMAS EN SISTEMAS APLICATIVOS CLARO':'Q','REPLANTEAMIENTO':'R',
		'REQUIERE MOVIL ELITE':'=','SUSCRIPTOR NO DESEA/NO REQUIERE TRABAJOS':'E','SUSCRIPTOR NO ESTA EN CONDICIÓN DE ATENDER':'?',
		'UNIDAD POSIBLE FRAUDE':'V','VENTA DEVUELTA AL ASESOR':'4','NO CONTACTO CON CLIENTE':'C','INCUMPLIMIENTO ALIADO':"I",
